...
/**
 * Example on how to use TextFilters: RegexGroupFilter and RegexFirstMatchFilter
 */
public class VariableEvaluation7 {
	...
	public static void test1() throws ParException, EvaluationException,
		...
		logger.info("\n\t>>>>>>>>>>>>>>>>> test1 create a RegexGroupFilter");
		...
		TextFilter rgf = new RegexGroupFilter(contents, "\\s\\d,");

		System.out.println("RegexGroupFilter: " + rgf.info());
	...
	public static void test2() throws ParException, EvaluationException,
			ConfigurationException, FilterException, IOException {
		logger.info("\n\t>>>>>>>>>>>>>>>>> test1 create a RegexFirstMatchFilter");
		...
		TextFilter rgf = new RegexFirstMatchFilter(contents, "\\s\\d,");

		System.out.println("RegexSingletonFilter: " + rgf.info());
