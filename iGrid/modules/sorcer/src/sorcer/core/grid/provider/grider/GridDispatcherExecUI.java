...
public class GridDispatcherExecUI extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if ("Menu".equals(cmd)) {
			...
			System.out.println("GridDispatcherExecUI.actionPerformed::item="
					+ item);
			if ("Windows".equals(item)) {
				System.out
						.println("GridDispatcherExecUI.actionPerformed::item matches Windows");
				JFrame temp = new JFrame();
				temp.setTitle("Windows");
				temp.getContentPane().setLayout(
						new BoxLayout(temp.getContentPane(), BoxLayout.Y_AXIS));
			...
			if ("Solaris".equals(item)) {
				System.out
						.println("GridDispatcherExecUI.actionPerformed::item matches Solaris");
				JFrame temp = new JFrame();
			...
			if ("Linux".equals(item)) {
				System.out
						.println("GridDispatcherExecUI.actionPerformed::item matches Linux");
				JFrame temp = new JFrame();
				temp.setTitle("Linux");
				temp.getContentPane().setLayout(
						new BoxLayout(temp.getContentPane(), BoxLayout.Y_AXIS));
