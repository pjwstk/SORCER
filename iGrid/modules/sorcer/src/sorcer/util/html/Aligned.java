...
public interface Aligned {
	...
	final public static int TOP = 4; // Element is top aligned
	final public static int MIDDLE = 5; // Element is middle aligned
	final public static int BOTTOM = 6; // Element is bottom aligned
}
