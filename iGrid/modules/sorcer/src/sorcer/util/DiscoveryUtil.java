...
public class DiscoveryUtil {
	public static void dumpRegistrar(ServiceRegistrar aRegistrar)
		...
		System.out.println("Registrar ServiceID: " + aRegistrar.getServiceID());
	...
	public static ServiceMatches findServicesOfType(Class aClass,
			ServiceRegistrar aRegistrar) throws RemoteException {

		ServiceTemplate myTemplate = new ServiceTemplate(null,
				new Class[] { aClass }, null);
	...
	public static void dump(ServiceMatches aMatches) {
		...
		for (int i = 0; i < aMatches.totalMatches; i++) {
			System.out.println("ServiceID: " + aMatches.items[i].serviceID
	...
	public static void dump(ServiceItem anItem) {
		System.out.println("ServiceID: " + anItem.serviceID + ", "
				+ anItem.service);
		System.out.print("Interfaces: ");
