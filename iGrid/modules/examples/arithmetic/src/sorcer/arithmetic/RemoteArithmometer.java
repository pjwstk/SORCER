...
public class RemoteArithmometer implements ArithmeticRemote, Serializable, SorcerConstants {

	private static final long serialVersionUID = 7639264751868012735L;
	
	private final static Logger logger = Logger.getLogger(RemoteArithmometer.class
			.getName());
